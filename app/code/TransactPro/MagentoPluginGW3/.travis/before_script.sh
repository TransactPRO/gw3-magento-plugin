...
composer config repositories.travis_to_test git https://github.com/ybratukhin/transactpro.git
composer require ybratukhin/transactpro:dev-master#$TRAVIS_COMMIT

# prepare for test suite
case $TEST_SUITE in
    integration)
        cp vendor/ybratukhin/transactpro/Test/Integration/phpunit.xml.dist dev/tests/integration/phpunit.xml
    ...
    static)
        ...
        ;;
    unit)
        cp vendor/ybratukhin/transactpro/Test/Unit/phpunit.xml.dist dev/tests/unit/phpunit.xml
    ;;
esac
