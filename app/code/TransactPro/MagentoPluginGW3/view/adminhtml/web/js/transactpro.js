...
define([
    ...
    return Class.extend({
        ...
        defaults: {
            $selector: null,
            selector: 'edit_form',
            container: 'payment_form_transactpro',
            active: false,
            scriptLoaded: false,
            transactpro: null,
        ...
        onActiveChange: function (isActive) {
            if (!isActive) {
                this.$selector.off('submitOrder.transactpro');
        ...
        enableEventListeners: function () {
            this.$selector.on('submitOrder.transactpro', this.submitOrder.bind(this));
        },
